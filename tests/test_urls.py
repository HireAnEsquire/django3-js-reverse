...
urlexclude = patterns("", url(r"^test_exclude_namespace/$", dummy_view, name="test_exclude_namespace_url1"))


# test namespace
pattern_ns_1 = patterns("", url(r"", include(basic_patterns)))

pattern_ns_2 = patterns("", url(r"", include(basic_patterns)))

pattern_ns_arg = patterns("", url(r"", include(basic_patterns)))

pattern_nested_ns = patterns("", url(r"^ns1/", include(pattern_ns_1, namespace="ns1")))
